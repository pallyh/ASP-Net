...
namespace Intro.Migrations
{
    ...
    [Migration("20220817174307_Relations1")]
            ...
            modelBuilder.Entity("Intro.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ff4e0eca-2f32-4585-b308-031b06cd09ad"),
                            Avatar = "",
                            Email = "",
                            Login = "Admin",
                            PassHash = "",
                            ...
                            RegMoment = new DateTime(2022, 8, 17, 20, 43, 7, 542, DateTimeKind.Local).AddTicks(5055)
                        });
                });
