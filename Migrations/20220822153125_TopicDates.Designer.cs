...
namespace Intro.Migrations
{
    ...
    [Migration("20220822153125_TopicDates")]
            ...
            modelBuilder.Entity("Intro.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1e99ea56-6c3f-41a4-abf4-47a05b6facf2"),
                            Avatar = "",
                            Email = "",
                            Login = "Admin",
                            PassHash = "",
                            ...
                            RegMoment = new DateTime(2022, 8, 22, 18, 31, 25, 48, DateTimeKind.Local).AddTicks(2927)
                        });
                });
